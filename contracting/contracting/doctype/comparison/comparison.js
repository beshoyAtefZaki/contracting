      ...
      frm.add_custom_button(
        ...
        function () {
          ...
          frappe.model.open_mapped_doc({
            method:
              "contracting.contracting.doctype.comparison.comparison.make_sales_order",
            frm: frm, //this.frm
          });
        },
        __("Create")
  ...
  make_purchase_order: function (frm) {
    ...
    var dialog = new frappe.ui.Dialog({
      ...
      primary_action(args) {
        ...
        return frappe.call({
          method:
            "contracting.contracting.doctype.comparison.comparison.make_purchase_order",
          freeze: true,
...
frappe.ui.form.on("Comparison Item", {
  clearance_item: (frm, cdt, cdn) => {
    ...
    if (local.clearance_item) {
      frappe.call({
        method:
          "contracting.contracting.doctype.comparison.comparison.get_item_price",
        args: {
