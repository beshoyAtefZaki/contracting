...
frappe.ui.form.on("Clearance", {
              ...
              frm.add_custom_button(
                ...
                function () {
                  frappe.model.open_mapped_doc({
                    method:
                      "contracting.contracting.doctype.clearance.clearance.clearance_make_purchase_invoice",
                    frm: frm,
                  });
                },
                __("Create")
  ...
  sales_order: function (frm) {
    frappe.call({
      method: "contracting.contracting.global_data.get_sales_order_data",
      args: {
  ...
  get_item_price(frm, cdt, cdn) {
    ...
    if (
      ...
      frappe.call({
        method:
          "contracting.contracting.doctype.clearance.clearance.get_item_price",
        args: {
